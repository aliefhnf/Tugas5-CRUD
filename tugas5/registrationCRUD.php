...
elseif ($action == 'read') {
	$syntaxsql = "SELECT FirstName, LastName, Username, Email, Address, Address2, Country, State, ZIP, Payment, Name_Card, Credit_Number, Expiration, CVV FROM user WHERE Username='$hasil[Username]'";
}
else {
	echo "ERROR ACTION";
	exit();
